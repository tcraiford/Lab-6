...
Level.prototype.obstacleAt = function (pos, size) {
  var xStart = Math.floor(pos.x); //Math.floor always rounds a number down
  var xEnd = Math.ceil(pos.x + size.x); //Math.ceil always rounds number up
...
Player.prototype.moveY = function(step, level, keys) {
  // Accelerate player downwards always (gravity)
